...
function onPlayerStateChange(event) { 
	...
	if (event.data ==YT.PlayerState.PLAYING){
		ga('send', 'event', 'Videos', 'Play', videoArray[videoarraynum]);
		//thy video plays
	...
	if (event.data ==YT.PlayerState.ENDED){
		ga('send', 'event', 'Videos', 'Watch to End', videoArray[videoarraynum]);
	} 
	...
	if (event.data ==YT.PlayerState.PAUSED && _pauseFlag == false){
		ga('send', 'event', 'Videos', 'Pause', videoArray[videoarraynum]);
